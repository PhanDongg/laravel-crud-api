...
// Route::prefix('admin')->group(function () {
    ...
    //home dashboard
    Route::get('/dashboard', [App\Http\Controllers\Admin\DashboardController::class, 'index'])->name('admin.dashboards');
});
...
Route::middleware('auth.user')->prefix('user')->group(function () {
    ...
    //home dashboard
    Route::get('/dashboard1', [App\Http\Controllers\User\DashboardController::class, 'index'])->name('user.dashboards');
});
